...
public class Activity_BLTE_Services extends AppCompatActivity implements ExpandableListView.OnChildClickListener {
    private final static String TAG = Activity_BLTE_Services.class.getSimpleName();
...
//            mGattUpdateReceiver.setBTLeService(null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = intent.getStringExtra(Activity_BLTE_Services.EXTRA_NAME);
        address = intent.getStringExtra(Activity_BLTE_Services.EXTRA_ADDRESS);
