...
//        Utils.toast(context, "List Item clicked");
        ...
        Intent intent = new Intent(this, Activity_BLTE_Services.class);
        intent.putExtra(Activity_BLTE_Services.EXTRA_NAME, name);
        intent.putExtra(Activity_BLTE_Services.EXTRA_ADDRESS, address);
